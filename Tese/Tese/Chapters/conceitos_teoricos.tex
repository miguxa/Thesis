...
Os valores lidos foram então estudados utilizando um gráfico, sendo que a sua análise está descrita na secção XXX.
...
O sistema Android é um sistema operativo para telemóveis desenvolvido pela Google, que utiliza Linux na sua base e tem como principal objetivo o desenvolvimento de aplicação para telemóveis e tablets que disponham de ecrã táctil.
...
\section{Processamento - HTML}
\label{sec:html}

\section{Processamento - PHP}
\label{sec:php}

\section{Processamento - MySQL}
\label{sec:MySQL}