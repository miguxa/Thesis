...
\documentclass[
  ...
  printcommittee=false,  % set to 'false' from submitted versins who should not have 
	...
	biblatex={            % Options for biblatex (see biblatex documentation)
		style=authoryear,      % numeric(*), alphabetic, authoryear, ieee
		...
		sortcites=true,     % If numeric, sort cites by crescent order
   		hyperref=false       % Hyperlinks in citations: true(*) false
	},
...
% e.g.
 \majorfield[pt]={1Engenharia Eletrotécnica e de Computadores}
%%============================================================

% Title of the dissertation/thesis
% Use "\\" to break the title into two or more lines
\title{Deteção e registo automático de \\irregularidades no asfalto}
\subtitle{Utilizando comunicação bluetooth e wi-fi}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Miguel Filipe Batista Prego}{Miguel Prego}
\authordegree{Licenciado em Engenharia Eletrotécnica e de Computadores}
...
% use [f] for female and [m] for male
\adviser[m]{José Manuel Matos Ribeiro da Fonseca}{\newline Professor Auxiliar com Agregação} {\newline Faculdade de Ciências e Tecnologia \newline Universidade Nova de Lisboa} 
...
\chapterfile{estado_da_arte}
\chapterfile{conceitos_teoricos}
\chapterfile{trabalho_desenvolvido}
\chapterfile{conclusao}

\appendixfile{anexoArduino}
\appendixfile{anexoApp}
\appendixfile{anexoSite}
